...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NewLabel.myconcept'
        db.delete_column('skosxl_newlabel', 'myconcept_id')

        # Adding field 'NewLabel.concept'
        db.add_column('skosxl_newlabel', 'concept', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['skosxl.Concept'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'NewLabel.myconcept'
        db.add_column('skosxl_newlabel', 'myconcept', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['skosxl.Concept'], null=True, blank=True), keep_default=False)

        # Deleting field 'NewLabel.concept'
        db.delete_column('skosxl_newlabel', 'concept_id')

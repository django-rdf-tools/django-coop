...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scheme.slug'
        db.add_column('skosxl_scheme', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Concept.slug'
        db.add_column('skosxl_concept', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Scheme.slug'
        db.delete_column('skosxl_scheme', 'slug')

        # Deleting field 'Concept.slug'
        db.delete_column('skosxl_concept', 'slug')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Concept.notation'
        db.add_column('skosxl_concept', 'notation', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Concept.notation'
        db.delete_column('skosxl_concept', 'notation')
    ...
    models = {
        ...
        'skosxl.concept': {
            ...
            'notation': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),

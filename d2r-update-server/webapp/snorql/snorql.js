...
function Snorql() {
    ...
    this._updateendpoint = document.location.href.match(/^([^?]*)snorql\//)[1] + 'sparqlupdate';
    ...
    this.submitUpdateStatement = function() {
	
	statement =	    this._getPrefixes() + document.getElementById('updatetext').value;
	...
	http.open("POST", this._updateendpoint, true);

	postParameters = "request=" + statement;

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SchemaClass', fields ['class_name']
        db.create_unique('d2rq_schemaclass', ['class_name'])

        # Adding unique constraint on 'SchemaProperty', fields ['prop_name']
        db.create_unique('d2rq_schemaproperty', ['prop_name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SchemaProperty', fields ['prop_name']
        db.delete_unique('d2rq_schemaproperty', ['prop_name'])

        # Removing unique constraint on 'SchemaClass', fields ['class_name']
        db.delete_unique('d2rq_schemaclass', ['class_name'])
    ...
    models = {
        ...
        'd2rq.schemaclass': {
            ...
            'class_name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '250'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'd2rq.schemaproperty': {
            ...
            'prop_name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '250'}),
            'schema': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['d2rq.Schema']"})
        }
    }

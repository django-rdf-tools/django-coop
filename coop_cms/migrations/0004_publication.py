...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.publication'
        db.add_column('coop_cms_article', 'publication', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.publication'
        db.delete_column('coop_cms_article', 'publication')
    ...
    models = {
        ...
        'coop_cms.article': {
            ...
            'publication': ('django.db.models.fields.IntegerField', [], {}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NavNode.in_navigation'
        db.add_column('coop_cms_navnode', 'in_navigation', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NavNode.in_navigation'
        db.delete_column('coop_cms_navnode', 'in_navigation')

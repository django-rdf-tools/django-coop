...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('coop_cms_article', 'content', self.gf('html_field.db.models.fields.HTMLField')())


    def backwards(self, orm):
        
        # Changing field 'Article.content'
        db.alter_column('coop_cms_article', 'content', self.gf('django.db.models.fields.TextField')())

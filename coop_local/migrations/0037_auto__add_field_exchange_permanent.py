...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exchange.permanent'
        db.add_column('coop_local_exchange', 'permanent', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Exchange.permanent'
        db.delete_column('coop_local_exchange', 'permanent')
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 8, 15, 24, 8, 529440)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_geo.Location']", 'null': 'True', 'blank': 'True'}),

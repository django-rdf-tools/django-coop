...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.telephone_fixe'
        db.add_column('coop_local_site', 'telephone_fixe', self.gf('django.db.models.fields.CharField')(max_length=14, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.telephone_fixe'
        db.delete_column('coop_local_site', 'telephone_fixe')

        for initiative in orm.Initiative.objects.all():
            phone = initiative.telephone_fixe
            site = initiative.sites.all()[0]
            site.telephone_fixe = phone
            site.save()
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 12, 7, 16, 45, 32, 823163)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

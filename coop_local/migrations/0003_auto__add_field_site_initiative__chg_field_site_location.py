...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.initiative'
        db.add_column('coop_local_site', 'initiative', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='new_rel', null=True, to=orm['coop_local.Initiative']), keep_default=False)

        # Changing field 'Site.location'
        db.alter_column('coop_local_site', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['coop_geo.Location']))


    def backwards(self, orm):
        
        # Deleting field 'Site.initiative'
        db.delete_column('coop_local_site', 'initiative_id')

        # Changing field 'Site.location'
        db.alter_column('coop_local_site', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_geo.Location'], null=True))
    ...
    models = {
        ...
        'coop_local.event': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'}),
            'datetime': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 11, 11, 18, 56, 51, 443726)'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 11, 11, 18, 56, 51, 460605)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_local.Membre']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'}),
            'org': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_local.Initiative']", 'null': 'True', 'blank': 'True'}),
        ...
        'coop_local.initiative': {
            ...
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'old_rel'", 'symmetrical': 'False', 'to': "orm['coop_local.Site']"}),
        ...
        'coop_local.site': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initiative': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'new_rel'", 'null': 'True', 'to': "orm['coop_local.Initiative']"}),
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_geo.Location']"}),

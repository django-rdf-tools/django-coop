...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Engagement.membre'
        db.alter_column('coop_local_engagement', 'membre_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.Person']))

        # Changing field 'Exchange.member'
        db.alter_column('coop_local_exchange', 'member_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.Person'], null=True))
    ...
    def backwards(self, orm):
        ...
        db.create_table('coop_local_membre', (
            ('username', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, blank=True)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('email_sha1', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True)),
        ...
        # Changing field 'Engagement.membre'
        db.alter_column('coop_local_engagement', 'membre_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.Membre']))

        # Changing field 'Exchange.member'
        db.alter_column('coop_local_exchange', 'member_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.Membre'], null=True))
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 16, 18, 30, 44, 683649)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_geo.Location']", 'null': 'True', 'blank': 'True'}),

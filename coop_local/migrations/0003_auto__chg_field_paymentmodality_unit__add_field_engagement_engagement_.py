...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PaymentModality.unit'
        db.alter_column('coop_local_paymentmodality', 'unit', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Adding field 'Engagement.engagement_display'
        db.add_column('coop_local_engagement', 'engagement_display', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1), keep_default=False)

        # Changing field 'Engagement.uuid'
        db.alter_column('coop_local_engagement', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=36, null=True))

        # Changing field 'Engagement.uri'
        db.alter_column('coop_local_engagement', 'uri', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Person.email_sha1'
        db.alter_column('coop_local_person', 'email_sha1', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Person.notes'
        db.alter_column('coop_local_person', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Person.uri'
        db.alter_column('coop_local_person', 'uri', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PaymentModality.unit'
        raise RuntimeError("Cannot reverse this migration. 'PaymentModality.unit' and its values cannot be restored.")

        # Deleting field 'Engagement.engagement_display'
        db.delete_column('coop_local_engagement', 'engagement_display')

        # Changing field 'Engagement.uuid'
        db.alter_column('coop_local_engagement', 'uuid', self.gf('django.db.models.fields.CharField')(default='', max_length=36))

        # Changing field 'Engagement.uri'
        db.alter_column('coop_local_engagement', 'uri', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

        # Changing field 'Person.email_sha1'
        db.alter_column('coop_local_person', 'email_sha1', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

        # Changing field 'Person.notes'
        db.alter_column('coop_local_person', 'notes', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Person.uri'
        db.alter_column('coop_local_person', 'uri', self.gf('django.db.models.fields.CharField')(default='', max_length=250))
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_geo.Location']", 'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'exchange'", 'null': 'True', 'to': "orm['coop_local.Organization']"}),

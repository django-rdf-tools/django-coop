...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Engagement.org_admin'
        db.add_column('coop_local_engagement', 'org_admin', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Changing field 'Article.content'
        db.alter_column('coop_local_article', 'content', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Deleting field 'Engagement.org_admin'
        db.delete_column('coop_local_engagement', 'org_admin')

        # Changing field 'Article.content'
        db.alter_column('coop_local_article', 'content', self.gf('html_field.db.models.fields.HTMLField')())

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exchange.uuid'
        db.add_column('coop_local_exchange', 'uuid', self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Exchange.uuid'
        db.delete_column('coop_local_exchange', 'uuid')
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 8, 16, 46, 35, 455666)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_geo.Location']", 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('coop_local_paymentmodality', (
            ...
            ('exchange', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.Exchange'])),
            ('modality', self.gf('django.db.models.fields.PositiveSmallIntegerField')(blank=True)),
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 8, 18, 4, 37, 797965)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_geo.Location']", 'null': 'True', 'blank': 'True'}),
        ...
        'coop_local.paymentmodality': {
            ...
            'exchange': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_local.Exchange']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modality': ('django.db.models.fields.PositiveSmallIntegerField', [], {'blank': 'True'}),

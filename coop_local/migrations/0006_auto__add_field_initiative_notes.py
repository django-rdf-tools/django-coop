...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Initiative.notes'
        db.add_column('coop_local_initiative', 'notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Initiative.notes'
        db.delete_column('coop_local_initiative', 'notes')
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 12, 6, 9, 45, 44, 101287)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

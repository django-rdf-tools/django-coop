...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exchange.location'
        db.add_column('coop_local_exchange', 'location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_geo.Location'], null=True, blank=True), keep_default=False)

        # Adding field 'Exchange.area'
        db.add_column('coop_local_exchange', 'area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_geo.Area'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Exchange.location'
        db.delete_column('coop_local_exchange', 'location_id')

        # Deleting field 'Exchange.area'
        db.delete_column('coop_local_exchange', 'area_id')
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 12, 9, 17, 5, 38, 66558)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Initiative.location'
        db.delete_column('coop_local_initiative', 'location_id')


    def backwards(self, orm):
        
        # Adding field 'Initiative.location'
        db.add_column('coop_local_initiative', 'location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_geo.Location'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 12, 21, 17, 35, 5, 923666)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

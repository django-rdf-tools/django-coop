...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('coop_local_initiative', 'coop_local_organization')
        
    def backwards(self, orm):
        db.rename_table('coop_local_organization', 'coop_local_initiative')
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 16, 22, 54, 55, 659985)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_geo.Location']", 'null': 'True', 'blank': 'True'}),

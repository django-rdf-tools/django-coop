...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('coop_local_initiative', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50))

        # Adding field 'Engagement.uri'
        db.add_column('coop_local_engagement', 'uri', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Initiative.slug'
        db.alter_column('coop_local_initiative', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))

        # Deleting field 'Engagement.uri'
        db.delete_column('coop_local_engagement', 'uri')
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 12, 9, 18, 41, 59, 677357)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

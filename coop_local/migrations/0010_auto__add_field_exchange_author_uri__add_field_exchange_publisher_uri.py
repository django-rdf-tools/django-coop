...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Exchange.author_uri'
        db.add_column('coop_local_exchange', 'author_uri', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Exchange.publisher_uri'
        db.add_column('coop_local_exchange', 'publisher_uri', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Exchange.author_uri'
        db.delete_column('coop_local_exchange', 'author_uri')

        # Deleting field 'Exchange.publisher_uri'
        db.delete_column('coop_local_exchange', 'publisher_uri')
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 12, 9, 17, 2, 38, 800852)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

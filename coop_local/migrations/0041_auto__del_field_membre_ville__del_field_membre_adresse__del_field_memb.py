...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Membre.ville'
        db.delete_column('coop_local_membre', 'ville')

        # Deleting field 'Membre.adresse'
        db.delete_column('coop_local_membre', 'adresse')

        # Deleting field 'Membre.code_postal'
        db.delete_column('coop_local_membre', 'code_postal')


    def backwards(self, orm):
        
        # Adding field 'Membre.ville'
        db.add_column('coop_local_membre', 'ville', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Membre.adresse'
        db.add_column('coop_local_membre', 'adresse', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Membre.code_postal'
        db.add_column('coop_local_membre', 'code_postal', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 13, 18, 33, 28, 479720)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_geo.Location']", 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Initiative.vcal'
        db.delete_column('coop_local_initiative', 'vcal')

        # Deleting field 'Initiative.telephone_fixe'
        db.delete_column('coop_local_initiative', 'telephone_fixe')

        # Deleting field 'Initiative.rss'
        db.delete_column('coop_local_initiative', 'rss')

        # Deleting field 'Initiative.mobile'
        db.delete_column('coop_local_initiative', 'mobile')


    def backwards(self, orm):
        
        # Adding field 'Initiative.vcal'
        db.add_column('coop_local_initiative', 'vcal', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Initiative.telephone_fixe'
        db.add_column('coop_local_initiative', 'telephone_fixe', self.gf('django.db.models.fields.CharField')(max_length=14, null=True, blank=True), keep_default=False)

        # Adding field 'Initiative.rss'
        db.add_column('coop_local_initiative', 'rss', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Initiative.mobile'
        db.add_column('coop_local_initiative', 'mobile', self.gf('django.db.models.fields.CharField')(max_length=14, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 16, 15, 6, 7, 15670)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_geo.Location']", 'null': 'True', 'blank': 'True'}),

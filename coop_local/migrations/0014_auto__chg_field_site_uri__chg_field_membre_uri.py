...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Site.uri'
        db.alter_column('coop_local_site', 'uri', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

        # Changing field 'Membre.uri'
        db.alter_column('coop_local_membre', 'uri', self.gf('django.db.models.fields.CharField')(max_length=250))


    def backwards(self, orm):
        
        # Changing field 'Site.uri'
        db.alter_column('coop_local_site', 'uri', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Membre.uri'
        db.alter_column('coop_local_membre', 'uri', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 12, 10, 9, 49, 51, 570457)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

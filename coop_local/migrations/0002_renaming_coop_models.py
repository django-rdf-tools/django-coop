...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('coop_local_membercategory', 'coop_local_personcategory')
        db.rename_table('coop_local_membre', 'coop_local_person')
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 16, 16, 26, 13, 836474)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_geo.Location']", 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Membre', fields ['username']
        db.create_unique('coop_local_membre', ['username'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Membre', fields ['username']
        db.delete_unique('coop_local_membre', ['username'])
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 13, 13, 38, 46, 602013)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_geo.Location']", 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('coop_local_engagement', 'membre_id', 'person_id')
        db.rename_column('coop_local_engagement', 'initiative_id', 'organization_id')
        db.rename_column('coop_local_engagement', 'fonction', 'role_detail')
        db.rename_column('coop_local_exchange', 'org_id', 'organization_id')
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 17, 0, 0, 22, 352579)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_geo.Location']", 'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'}),

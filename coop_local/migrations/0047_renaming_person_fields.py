...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('coop_local_membre', 'prenom', 'first_name')
        db.rename_column('coop_local_membre', 'nom', 'last_name')
        db.rename_column('coop_local_initiative', 'acronym', 'subtitle')
        

    def backwards(self, orm):
        # Rename 'full_name' field to 'name'
        db.rename_column('coop_local_membre', 'last_name', 'nom')
        db.rename_column('coop_local_membre', 'first_name', 'prenom')
        db.rename_column('coop_local_initiative', 'subtitle', 'acronym')
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 16, 15, 8, 17, 466270)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_geo.Location']", 'null': 'True', 'blank': 'True'}),

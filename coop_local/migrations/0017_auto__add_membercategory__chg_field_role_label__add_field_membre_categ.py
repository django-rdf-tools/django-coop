...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Role.label'
        db.alter_column('coop_local_role', 'label', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Adding field 'Membre.category'
        db.add_column('coop_local_membre', 'category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_local.MemberCategory'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Role.label'
        db.alter_column('coop_local_role', 'label', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Deleting field 'Membre.category'
        db.delete_column('coop_local_membre', 'category_id')
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 12, 19, 18, 7, 53, 592621)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coop_local.membre': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_local.MemberCategory']", 'null': 'True', 'blank': 'True'}),

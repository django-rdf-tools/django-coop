...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Membre.telephone_portable'
        db.delete_column('coop_local_membre', 'telephone_portable')

        # Deleting field 'Membre.pub_location'
        db.delete_column('coop_local_membre', 'pub_location')

        # Deleting field 'Membre.telephone_fixe'
        db.delete_column('coop_local_membre', 'telephone_fixe')

        # Deleting field 'Membre.pub_mobile'
        db.delete_column('coop_local_membre', 'pub_mobile')

        # Deleting field 'Membre.pub_name'
        db.delete_column('coop_local_membre', 'pub_name')

        # Deleting field 'Membre.pub_phone'
        db.delete_column('coop_local_membre', 'pub_phone')


    def backwards(self, orm):
        
        # Adding field 'Membre.telephone_portable'
        db.add_column('coop_local_membre', 'telephone_portable', self.gf('django.db.models.fields.CharField')(max_length=14, null=True, blank=True), keep_default=False)

        # Adding field 'Membre.pub_location'
        db.add_column('coop_local_membre', 'pub_location', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Membre.telephone_fixe'
        db.add_column('coop_local_membre', 'telephone_fixe', self.gf('django.db.models.fields.CharField')(max_length=14, null=True, blank=True), keep_default=False)

        # Adding field 'Membre.pub_mobile'
        db.add_column('coop_local_membre', 'pub_mobile', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Membre.pub_name'
        db.add_column('coop_local_membre', 'pub_name', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Membre.pub_phone'
        db.add_column('coop_local_membre', 'pub_phone', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 16, 15, 5, 8, 190943)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coop_geo.Location']", 'null': 'True', 'blank': 'True'}),

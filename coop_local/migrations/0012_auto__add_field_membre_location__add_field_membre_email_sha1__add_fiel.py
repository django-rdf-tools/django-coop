...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Membre.location'
        db.add_column('coop_local_membre', 'location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coop_geo.Location'], null=True, blank=True), keep_default=False)

        # Adding field 'Membre.email_sha1'
        db.add_column('coop_local_membre', 'email_sha1', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)

        # Adding field 'Membre.uri'
        db.add_column('coop_local_membre', 'uri', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Membre.location'
        db.delete_column('coop_local_membre', 'location_id')

        # Deleting field 'Membre.email_sha1'
        db.delete_column('coop_local_membre', 'email_sha1')

        # Deleting field 'Membre.uri'
        db.delete_column('coop_local_membre', 'uri')
    ...
    models = {
        ...
        'coop_local.exchange': {
            ...
            'expiration': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 12, 9, 18, 21, 50, 340540)', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'coop_local.membre': {
            ...
            'uri': ('django.db.models.fields.URLField', [], {'unique': 'True', 'max_length': '200', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Area.polygon'
        db.alter_column('coop_geo_area', 'polygon', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')())


    def backwards(self, orm):
        
        # Changing field 'Area.polygon'
        db.alter_column('coop_geo_area', 'polygon', self.gf('django.contrib.gis.db.models.fields.PolygonField')())

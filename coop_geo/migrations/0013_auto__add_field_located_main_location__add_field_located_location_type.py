...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Located.main_location'
        db.add_column('coop_geo_located', 'main_location', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Located.location_type'
        db.add_column('coop_geo_located', 'location_type', self.gf('django.db.models.fields.CharField')(default=u'head office', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Located.main_location'
        db.delete_column('coop_geo_located', 'main_location')

        # Deleting field 'Located.location_type'
        db.delete_column('coop_geo_located', 'location_type')
    ...
    models = {
        ...
        'coop_geo.located': {
            ...
            'location_type': ('django.db.models.fields.CharField', [], {'default': "u'head office'", 'max_length': '100', 'blank': 'True'}),
            'main_location': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        'coop_geo.location': {

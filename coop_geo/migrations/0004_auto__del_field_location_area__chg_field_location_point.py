...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.point'
        db.alter_column('coop_geo_location', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')(default='POINT(0 0)'))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Location.point'
        db.alter_column('coop_geo_location', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True))

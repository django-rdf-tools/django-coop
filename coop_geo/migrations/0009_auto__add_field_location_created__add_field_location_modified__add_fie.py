...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('coop_geo_location', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True), keep_default=False)

        # Adding field 'Location.modified'
        db.add_column('coop_geo_location', 'modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True), keep_default=False)

        # Adding field 'Location.uuid'
        db.add_column('coop_geo_location', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.created'
        db.delete_column('coop_geo_location', 'created')

        # Deleting field 'Location.modified'
        db.delete_column('coop_geo_location', 'modified')

        # Deleting field 'Location.uuid'
        db.delete_column('coop_geo_location', 'uuid')
